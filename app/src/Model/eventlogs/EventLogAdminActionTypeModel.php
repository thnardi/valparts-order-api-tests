...
use Farol360\Ancora\Model\EventLogAdminActionType;

class EventLogAdminActionTypeModel extends Model
{
  public function add(EventLogAdminActionType $eventLog)
  {
    $sql =
      "INSERT INTO event_log_types_admin_actions (
        slug,
        name,
        description
      )
    ...
    $data['status'] = $exec;
    $data['table'] = 'event_log_types_admin_actions';
    $data['function'] = 'add';
  ...
  public function get(int $id)
  {
    ...
    // verifica se ocorreu com sucesso o execute
    if ($exec) {
      $stmt->setFetchMode(\PDO::FETCH_CLASS | \PDO::FETCH_PROPS_LATE, EventLogAdminActionType::class);
