...
use Farol360\Ancora\Model\EventLogUserAccessType;

class EventLogUserAccessTypeModel extends Model
{
  public function add(EventLogUserAccessType $eventLog)
  {
    $sql =
      "INSERT INTO event_log_types_user_access (
        slug,
        name,
        description
      )
  ...
  public function get(int $id)
  {
    ...
    // verifica se ocorreu com sucesso o execute
    if ($exec) {
      $stmt->setFetchMode(\PDO::FETCH_CLASS | \PDO::FETCH_PROPS_LATE, EventLogUserAccessType::class);
